...
class Im2Latex(LightningDataModule):
    ...
    @property
    def processed_train_images_dirname(self):
        return self.processed_images_dirname / "images_train"

    @property
    def processed_val_images_dirname(self):
        return self.processed_images_dirname / "images_val"

    @property
    def processed_test_images_dirname(self):
        return self.processed_images_dirname / "images_test"
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        if stage in ("fit", None):
            ...
            self.train_dataset = BaseDataset(
                self.processed_train_images_dirname,
            ...
            self.val_dataset = BaseDataset(
                self.processed_val_images_dirname,
        ...
        if stage in ("test", None):
            ...
            self.test_dataset = BaseDataset(
                self.processed_test_images_dirname,
