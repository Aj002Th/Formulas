...
if __name__ == "__main__":
    ...
    model.build_pred()
    # model.build_pred(Config([dir_output + "vocab.json", dir_output + "model.json", dir_output + "training.json", dir_output + "data.json"]))
    # model.restore("D:/Code/Items/handwriting_formula-latex/results/small/BEST_checkpoint_small.pth.tar")
